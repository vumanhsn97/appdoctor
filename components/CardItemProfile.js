    ...
    render() {
        return (<View>
            ...
            <ListItem
                ...
                subtitle={(this.props.type == 'gender') ? ((this.state.update !== undefined) ? (this.state.update ? "Nam" : "Nữ") : (this.props.settingDetail ? "Nam" : "Nữ")):(this.state.update ? this.state.update : this.props.settingDetail)}
                rightIcon={
